...
pwm.ChangeDutyCycle(1) # Tells the servo to turn to the left ( -90 deg position )
sleep(5) # Tells the servo to Delay for 5sec
pwm.ChangeDutyCycle(7.5) # Tells the servo to turn to the neutral position ( at 0 deg position )
sleep(5) # Tells the servo to Delay for 5sec
pwm.ChangeDutyCycle(15) # Tells the servo to turn to the right ( +90 deg position )
sleep(5) # Tells the servo to Delay for 5sec
pwm.stop() # Stop the servo with 0 duty cycle ( at 0 deg position )
